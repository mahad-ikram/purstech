...
export default function ContactClient() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    // Simulate submission delay for now
              ...
              {submitted ? (
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="contact-name" className="text-xs text-gray-500 font-medium block mb-2 uppercase tracking-wider">
                        Your Name *
                      </label>
                      <input
                        id="contact-name"
                    ...
                    <div>
                      <label htmlFor="contact-email" className="text-xs text-gray-500 font-medium block mb-2 uppercase tracking-wider">
                        Email Address *
                      </label>
                      <input
                        id="contact-email"
                  ...
                  <div>
                    <label htmlFor="contact-subject" className="text-xs text-gray-500 font-medium block mb-2 uppercase tracking-wider">
                      Subject
                    </label>
                    <select
                      id="contact-subject"
                  ...
                  <div>
                    <label htmlFor="contact-message" className="text-xs text-gray-500 font-medium block mb-2 uppercase tracking-wider">
                      Message *
                    </label>
                    <textarea
                      id="contact-message"
                    ...
                    />
                    <div className={`text-right text-xs mt-1 ${form.message.length > 1800 ? "text-yellow-400" : "text-gray-600"}`}>
                  ...
                  <p className="text-xs text-gray-600 text-center">
                    ...
                    <Link href="/privacy" className="text-[#6C3AFF] hover:text-[#00D4FF] transition-colors">
                      Privacy Policy
                    </Link>.
                  </p>
                </div>
