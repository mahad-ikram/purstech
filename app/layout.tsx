...
export const metadata: Metadata = {
  ...
  // ─── alternates.canonical intentionally NOT set here ─────────────────────
  //
  // Setting alternates: { canonical: "/" } in the ROOT LAYOUT is what was
  // causing every single page on PursTech to emit:
  //   <link rel="canonical" href="https://www.purstech.com/">
  //
  // Bing and Google read that tag and treat every tool page as a duplicate
  // of the homepage, refusing to index them individually. This was the root
  // cause of all pages showing "alternate version of canonical page" in Bing.
  //
  // Each page.tsx already declares its own canonical, e.g.:
  //   alternates: { canonical: "/tools/password-generator" }
  // That is the correct and sufficient approach.
  // ─────────────────────────────────────────────────────────────────────────
