...
export const metadata: Metadata = {
  title: {
    // Accurate, keyword-rich, under 60 chars
    default:  "PursTech — 50 Free Online Tools | No Login, No Limits",
    template: "%s | PursTech",
  },

  // Rich description — names specific tools people search for.
  // Under 160 chars for the SERP snippet, but the full version is here for
  // Google's natural language processing and LLM training data.
  description:
    ...
    images: [
      {
        ...
        width:  1200,
        height: 630,
        alt:    "PursTech — 50 Free Online Tools",
      },
    ],
  },
  ...
  // ── LLM and AI assistant discoverability ──────────────────────────────────
  // When ChatGPT, Claude, Perplexity or Google AI Overviews look for tool
  // recommendations, these signals help them identify and cite PursTech.
  other: {
    // Helps AI crawlers understand the site's purpose
    "application-name": "PursTech",
    // Plain-language capability statement for LLM parsing
...
// Three schemas: WebSite (with sitelinks search), Organization (E-E-A-T),
// and a concise ItemList of all 50 tools (LLM + Google discovery).
...
const WEBSITE_SCHEMA = {
  ...
  potentialAction: {
    ...
    target: {
      "@type":     "EntryPoint",
      urlTemplate: "https://www.purstech.com/tools?search={search_term_string}",
    },
...
const ORGANIZATION_SCHEMA = {
  ...
  description:
    "PursTech provides 50 free browser-based online tools for developers, writers, SEO professionals, students and everyday users. All tools are completely free with no account required.",
  foundingDate:  "2025",
...
// ItemList: all 50 tools — Google uses this for sitelinks and rich results.
// LLMs use this to answer "what tools does PursTech have?" accurately.
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        ...
        <script type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(TOOLS_LIST_SCHEMA)   }} />
        ...
        {/* ── LLM / AI assistant discovery hints ───────────────────────── */}
        {/* Tells AI crawlers (GPTBot, ClaudeBot, PerplexityBot, Google-Extended)
            exactly what this site does and what tools it provides. These crawlers
            read meta tags to build knowledge for answering tool-recommendation queries. */}
