export const BLOG_POSTS: Record<string, {
  ...
  "best-free-word-counter-tools": {
    ...
    excerpt:      "We ran the same draft through 7 popular free word counters and compared the statistics, signup walls, ads and privacy of each.",
    category:     "Writing",
    readTime:     "8 min read",
...
<p>A word counter feels trivial until you remember what people paste into one: unreleased announcements, legal drafts, medical notes, unpublished manuscripts. Any hosted tool means that text travels to someone else's server, however briefly and however good their intentions. A counter that runs entirely in your browser removes the question — there is nothing to trust, because nothing leaves your machine.</p>
  ...
  "tinypng-alternatives": {
    ...
    relatedPosts: ["how-to-compress-images-without-losing-quality", "webp-vs-jpeg-vs-png-2026", "how-to-remove-background-gimp-canva"],
    heroImage:    "/blog-images/tinypng-alternatives.png",
    heroAlt:      "Infographic: TinyPNG's three limits — 5 MB file cap, 20-image batch ceiling and server uploads — with PursTech Image Compressor and Squoosh as the two tested alternatives that never upload, saving 50-80%",
    excerpt:      "TinyPNG is great — until you hit the 5 MB cap, the 20-file batch limit, or realise every image uploads to a server.",
...
`,
  ...
  "how-to-remove-background-gimp-canva": {
    ...
    relatedPosts: ["tinypng-alternatives", "how-to-compress-images-without-losing-quality"],
    heroImage:    "/blog-images/how-to-remove-background-gimp-canva.png",
    heroAlt:      "Cheat sheet: five GIMP background-removal methods matched to image types, next to a free browser AI remover with no signup versus Canva's Pro-only tool",
    excerpt:      "Step-by-step background removal in GIMP — Fuzzy Select, Color to Alpha, Paths and Foreground Select.",
    category:     "Image Tools",
    readTime:     "8 min read",
    publishedAt:  "July 6, 2026",
    updatedAt:    "July 6, 2026",
...
`,
  ...
  "how-to-check-word-count": {
    ...
    excerpt:      "Every way to check word count in Google Docs (desktop and mobile), Microsoft Word and PDF files.",
    category:     "Writing",
    readTime:     "6 min read",
...
<p>Word limits are rarely decorative. College application essays are cut off at hard caps, journal abstracts are rejected over a 10-word overshoot, ad platforms truncate headlines mid-sentence, and search engines trim meta descriptions around 160 characters. Checking the real number takes ten seconds with the methods above — and once you know where the counter lives in each app, you will never guess again.</p>
  ...
  "best-free-json-formatter-tools": {
    ...
    relatedPosts: ["base64-encoding-explained", "url-encoding-developer-guide"],
    heroImage:    "/blog-images/best-free-json-formatter-tools.png",
    heroAlt:      "Before and after: a minified single-line JSON object transformed into indented, syntax-highlighted, validated output",
...
<p>Paste any JSON into the PursTech JSON Formatter and click Format. Whether you are a developer debugging an API or a non-technical user reading a config file, a clean formatted view makes all the difference.</p>
  ...
  "how-to-compress-images-without-losing-quality": {
    ...
    relatedPosts: ["tinypng-alternatives", "webp-vs-jpeg-vs-png-2026"],
    heroImage:    "/blog-images/how-to-compress-images-without-losing-quality.png",
    heroAlt:      "Comparison card: smart lossy compression saves 50-80% and is rarely noticeable, lossless saves 5-25% with pixel-identical output",
...
<p><em>Update July 2026:</em> we hand-tested <a href="/blog/tinypng-alternatives">7 free TinyPNG alternatives</a> — including two that compress entirely in your browser without uploading anything.</p>
...
<p>Always compress before uploading. Use WebP as your primary format. Keep originals separately so you can recompress at different settings later. Test results on both desktop and mobile.</p>
  ...
  "strong-password-guide": {
    ...
    relatedPosts: ["merge-pdf-files-without-uploading", "base64-encoding-explained"],
    heroImage:    "/blog-images/strong-password-guide.png",
    heroAlt:      "Statistic card: a 16-character lowercase password has 450,000 times more combinations than 12 characters, with dictionary words, letter substitutions and keyboard patterns crossed out as mistakes",
...
<p>2FA adds a layer requiring physical possession of your phone. Enable it on every account that supports it — especially email, banking and social media.</p>
  ...
  "hex-vs-rgb-vs-hsl-color-formats": {
    ...
    relatedPosts: ["webp-vs-jpeg-vs-png-2026", "how-to-remove-background-gimp-canva"],
    heroImage:    "/blog-images/hex-vs-rgb-vs-hsl-color-formats.png",
    heroAlt:      "One purple swatch expressed three ways: HEX #6C3AFF, RGB 108 58 255, and HSL 255 100% 61%",
...
<p>All three formats represent the same color space in different notations. The PursTech Color Picker converts between all formats instantly — enter any color in any format and immediately see HEX, RGB, HSL, HSV and CMYK equivalents, ready to copy.</p>
  ...
  "qr-codes-for-business-complete-guide": {
    ...
    relatedPosts: ["free-seo-tools-that-work", "url-encoding-developer-guide"],
    heroImage:    "/blog-images/qr-codes-for-business-complete-guide.png",
    heroAlt:      "Comparison: static QR codes are free forever with a fixed destination, dynamic codes are paid with editable destinations and scan analytics",
...
<p>Static codes are simpler and completely free — ideal for single-use or low-volume applications. Dynamic codes allow destination updates and provide scan analytics. The PursTech QR Code Generator creates static codes ready for immediate use.</p>
  ...
  "base64-encoding-explained": {
    ...
    relatedPosts: ["url-encoding-developer-guide", "best-free-json-formatter-tools"],
    heroImage:    "/blog-images/base64-encoding-explained.png",
    heroAlt:      "Diagram: Base64 turns every 3 bytes into four 6-bit characters, so Hello becomes SGVsbG8= and output is about 33% larger",
...
<p>Standard Base64 uses + and / which have special meanings in URLs. URL-safe Base64 replaces these with - and _, making strings safe for URLs. Most JWT implementations use URL-safe Base64 without padding.</p>
  ...
  "bmi-calculator-guide-what-your-score-means": {
    ...
    relatedPosts: ["loan-calculator-with-extra-payments", "strong-password-guide"],
    heroImage:    "/blog-images/bmi-calculator-guide-what-your-score-means.png",
    heroAlt:      "BMI scale with WHO categories — underweight below 18.5, normal to 24.9, overweight to 29.9, obese from 30 — and the BMI = kg divided by height squared formula",
...
<p>Waist circumference is a particularly important complement — a waist above 102cm (men) or 88cm (women) indicates elevated metabolic risk regardless of BMI. Combined, these two measurements provide a much more complete health picture than either alone.</p>
  ...
  "url-encoding-developer-guide": {
    ...
    relatedPosts: ["base64-encoding-explained", "best-free-json-formatter-tools"],
    heroImage:    "/blog-images/url-encoding-developer-guide.png",
    heroAlt:      "Examples of percent-encoding: a space becomes %20, an ampersand becomes %26, and the UTF-8 character e-acute becomes %C3%A9",
...
<p>Always encode query parameter values when constructing URLs programmatically. Never concatenate user input into a URL without encoding. When debugging URL issues, decode the full URL first — the PursTech URL Encoder handles both encoding and decoding with a single click.</p>
  ...
  "free-seo-tools-that-work": {
    ...
    relatedPosts: ["tinypng-alternatives", "word-count-guide-every-platform", "qr-codes-for-business-complete-guide"],
    heroImage:    "/blog-images/free-seo-tools-that-work.png",
    heroAlt:      "Grid of six free SEO tools: Google Search Console, Google Analytics 4, PageSpeed Insights, Bing Webmaster Tools, Screaming Frog and free keyword tools",
...
<p>Your content should be as long as it needs to fully serve the reader's intent — and no longer. A reader asking "what is a QR code?" needs 200 words. A developer asking "how do I implement OAuth 2.0?" needs 2,000 words. Match depth to need and you will rarely get word count wrong.</p>
  ...
  "compress-pdf-without-losing-quality": {
    ...
    relatedPosts: ["merge-pdf-files-without-uploading", "how-to-compress-images-without-losing-quality"],
    heroImage:    "/blog-images/compress-pdf-without-losing-quality.png",
    heroAlt:      "Chart of four PDF compression levels: Low 300 DPI about 30% smaller for print, Medium 150 DPI about 60% recommended, High 96 DPI about 78% for mobile, Maximum 72 DPI about 90% for drafts",
    excerpt:      "Reduce PDF file size by 50-90% without visible quality loss. Complete 2026 guide covering compression levels, when to use each.",
    category:     "PDF Tools",
    readTime:     "7 min read",
...
<p>If your PDF is over 5MB and you're sharing it digitally, compressing it is almost always worth it. Medium compression saves more than half the file size with no visible quality loss. Use a browser-based tool to keep your document private, and reserve maximum compression for cases where every byte counts.</p>
  ...
  "merge-pdf-files-without-uploading": {
    title:        "Merge PDF Files Without Uploading: Privacy-First",
    slug:         "merge-pdf-files-without-uploading",
    relatedPosts: ["compress-pdf-without-losing-quality", "strong-password-guide"],
    heroImage:    "/blog-images/merge-pdf-files-without-uploading.png",
    heroAlt:      "Diagram: server-based PDF mergers upload files to their servers, browser-based merging keeps files on your device throughout",
    excerpt:      "Combine multiple PDFs into one file directly in your browser — no servers, no uploads, no privacy risks.",
    category:     "PDF Tools",
    readTime:     "6 min read",
    publishedAt:  "June 5, 2026",
    updatedAt:    "June 5, 2026",
...
<p>If you regularly merge PDFs containing personal, financial, or legal information, browser-based merging is the only sensible choice. The convenience cost is zero — it's just as fast as server-based alternatives, and the privacy improvement is total. For any document you wouldn't want a stranger to read, never upload it to a third-party PDF tool.</p>
  ...
  "loan-calculator-with-extra-payments": {
    ...
    heroAlt:      "Bar chart: on a $200,000 mortgage at 6.5%, extra monthly payments of $50, $100, $200 and $500 save $41,253 to $184,712 in interest",
    excerpt:      "Adding even small extra payments to your loan can cut years off the term and save thousands in interest.",
    category:     "Finance",
    readTime:     "8 min read",
    publishedAt:  "June 5, 2026",
    updatedAt:    "June 5, 2026",
...
<p>Extra payments are one of the most reliable ways to build wealth quickly. Unlike investing, the return is guaranteed and equals your loan's interest rate. Unlike refinancing, there are no fees or paperwork. The math works for anyone with a loan, even if you can only afford a small extra amount. Run your numbers through a loan calculator — the savings are usually larger than people expect.</p>
  ...
  "webp-vs-jpeg-vs-png-2026": {
    ...
    relatedPosts: ["how-to-compress-images-without-losing-quality", "tinypng-alternatives", "hex-vs-rgb-vs-hsl-color-formats"],
    heroImage:    "/blog-images/webp-vs-jpeg-vs-png-2026.png",
    heroAlt:      "Bar chart: the same 1920x1080 photo at quality 85 as PNG 2,400 KB, JPEG 780 KB, WebP 510 KB and AVIF 420 KB — WebP is 35% smaller than JPEG",
    excerpt:      "WebP produces files 25-35% smaller than JPEG at the same quality and is now supported by every browser.",
    category:     "Image Tools",
    readTime:     "7 min read",
    publishedAt:  "June 5, 2026",
    updatedAt:    "June 5, 2026",
...
<p><em>Related:</em> once you have picked a format, see our tested list of <a href="/blog/tinypng-alternatives">free TinyPNG alternatives</a> for compressing it without size caps.</p>
