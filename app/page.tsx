...
const FAQ_SCHEMA = {
  ...
  mainEntity: [
    { "@type": "Question", name: "Is PursTech really free?",
    ...
    { "@type": "Question", name: "Do I need to create an account or log in?",
    ...
    { "@type": "Question", name: "Are my files and data kept private?",
    ...
    { "@type": "Question", name: "What tools does PursTech offer?",
    ...
    { "@type": "Question", name: "Do the tools work on mobile phones?",
    ...
    { "@type": "Question", name: "Is there a usage limit?",
