...
export const metadata: Metadata = {
  // Renders: "Free BMI Calculator — Healthy Weight Range | PursTech" (53 chars ✅)
  ...
  keywords: [
    ...
    "bmi calculator imperial", "healthy weight range", "bmi prime calculator",
    "free bmi calculator online", "calculate bmi",
  ],
