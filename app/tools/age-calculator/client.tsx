...
const FAQ = [
  ...
  { q:"What is the day of the week I was born?", a:"Using the date you enter, the tool calculates which day of the week that date fell on using JavaScript's built-in Date object."                                                               },
];
...
export default function AgeCalculatorClient() {
  // ✅ Track tool usage in Supabase via admin dashboard
  useTrackTool("age-calculator", "finance");
  ...
  return (
    <div className="min-h-screen bg-[#0A0A14] text-white font-sans">
      ...
      <main className="max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 flex flex-col gap-5">
            ...
            <div className="bg-[#13131F] border border-white/5 rounded-2xl p-6 flex flex-col gap-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="dob" className="text-xs text-gray-500 font-medium block mb-2 uppercase tracking-wider">Date of Birth</label>
                  <input id="dob" type="date" value={dob} onChange={e => setDob(e.target.value)} max={TODAY}
                ...
                <div>
                  <label htmlFor="target" className="text-xs text-gray-500 font-medium block mb-2 uppercase tracking-wider">Calculate Age On</label>
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* ✅ Fixed: was <button> with no href — now <Link href="/pro"> */}
        ...
        <section className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              { step:"3", title:"View Your Results",    desc:"Click Calculate to see your exact age in years, months and days, plus total days, weeks, hours, minutes and birthday countdown." },
            ].map(s => (
      ...
      {/* ── Footer — fixed: added Privacy + Terms + Contact ── */}
