...
// app/admin/page.tsx — Admin Dashboard (restored)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-[#13131F] border border-white/5 rounded-2xl p-5 text-center">
          <div className="text-2xl font-extrabold text-green-400">14</div>
      ...
      <div className="bg-[#6C3AFF]/10 border border-[#6C3AFF]/20 rounded-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <div className="flex-1">
          <div className="text-sm font-bold text-white mb-0.5">Admin panel secured with server-side auth</div>
          <div className="text-xs text-gray-500">
            All <code className="bg-[#0A0A14] px-1 rounded">/api/admin/*</code> routes now require a valid session cookie.
            Password lives in Vercel env vars — never in client code.
            <strong className="text-gray-400"> Next: re-apply for AdSense (Tue/Wed morning, July 1–3) after the new content has aged.</strong>
          </div>
        </div>
        <Link href="/admin/messages"
